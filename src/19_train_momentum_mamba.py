...
print("===================================================")
print(" PHASE 9: Training Momentum Mamba Baseline")
print("===================================================")
...
def main():
    ...
    print("\nBuilding modular model with 'momentum_mamba' backbone...")
    model = build_modular_sac(
        ...
        cfg=cfg,
        backbone_type="momentum_mamba", # <-- CHANGED
    ...
    model.summary()
    print(f"\n[PAPER METRIC] Total Trainable Parameters (Momentum Mamba): {model.count_params():,}")

    os.makedirs("models", exist_ok=True)
    model_path = "models/momentum_mamba_baseline.keras" # <-- CHANGED
    ...
    print("\n--- Starting Momentum Mamba Training ---")
    history = model.fit(
        train_ds_mapped,
