...
class ClassBalancedFocalLoss(tf.keras.losses.Loss):
    ...
    def __init__(
        ...
        # Prevent excessive rare-class amplification
        weights = np.clip(
            weights,
            min_weight,
            max_weight
        ...
        for x, y in self.val_ds:
            ...
            if isinstance(predictions, dict):
                ...
                if "activity" in predictions:
                    ...
                    predictions = predictions["activity_output"]
...
def main():
    ...
    print("=" * 70)
    print("PHASE 10: TAR-Mamba V1 Training")
    print("=" * 70)
    ...
    #
    # The current TAR-Mamba V1 experiment is activity
    # classification. Boundary and phase targets remain
    # available in the dataset for later multi-task experiments.
    # --------------------------------------------------------
    ...
    print("\n" + "=" * 70)
    print("STARTING TAR-MAMBA TRAINING")
    print("=" * 70)
