...
print("===================================================")
print(" PHASE 8: Training Vanilla Mamba Baseline")
print("===================================================")
...
def main():
    ...
    print("\nBuilding modular model with 'mamba' backbone (Single Output)...")
    ...
    model.summary()
    print(f"\n[PAPER METRIC] Total Trainable Parameters (Vanilla Mamba): {model.count_params():,}")
    ...
    print("\n--- Starting Vanilla Mamba Training ---")
    history = model.fit(
        train_ds_mapped,
